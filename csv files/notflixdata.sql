...
--
-- RELATIONSHIPS FOR TABLE `acted_movie`:
--   `MOVIE_ID`
--       `movie` -> `ID`
--   `ACTOR_ID`
--       `actor` -> `ID`
...
--
-- RELATIONSHIPS FOR TABLE `acted_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `actor_prize_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `actor_prize_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `add_to_fav_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `add_to_fav_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `admin_website`:
--
...
('Donia Esawi', '$2y$10$rmUz2GZ./0NVLr.h4ipXuu5r2ZJwFFpmul/4AeAT.8lgD4DtNl9ty', 'donya.esawi@gmail.com', 19, 'F', 'F.png');
...
--
-- RELATIONSHIPS FOR TABLE `advertisement`:
--
...
--
-- RELATIONSHIPS FOR TABLE `director_prize_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `director_prize_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `fantasy_character`:
--
...
--
-- RELATIONSHIPS FOR TABLE `funded_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `funded_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `genre_relation_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `genre_relation_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `production_company`:
--
...
--
-- RELATIONSHIPS FOR TABLE `rate_movie`:
--
...
--
-- RELATIONSHIPS FOR TABLE `rate_series`:
--
...
--
-- RELATIONSHIPS FOR TABLE `season`:
--
...
(5, 'Batman: The Killing Joke', 'Alan Moore', 'https://static.wikia.nocookie.net/batman/images/e/eb/Batman_thekillingjoke_3.jpg/revision/latest/scale-to-width-down/314?cb=20090102142703', 'The plot revolves around a largely psychological battle between Batman and his longtime foe the Joker, who has escaped from Arkham Asylum. Batman paid a visit to Arkham Asylum, and specifically to the Joker/\'s cell. He then tells the Clown Prince of Crime that he/\'s been thinking of their battles, more specifically how they/\'re most likely going to end: One of them is most likely going to kill the other, whether it be Joker killing Batman, or Batman killing Joker, that most likely it may happen either sooner or later, and wonders if Joker himself is aware of that. However, he then realizes the man in the cell is not actually the Joker, and demands to know where he is. The Joker intends to drive Gotham City Police Commissioner James Gordon insane to prove that the most upstanding citizen is capable of going mad after having /\"one bad day/\". As part of his plan, the Joker managed to scam the owner of a run-down amusement park into giving him control, also poisoning him in the process whe'),
(6, 'Batman: The Killing Joke', 'Alan Moore', 'https://static.wikia.nocookie.net/batman/images/e/eb/Batman_thekillingjoke_3.jpg/revision/latest/scale-to-width-down/314?cb=20090102142703', 'The plot revolves around a largely psychological battle between Batman and his longtime foe the Joker, who has escaped from Arkham Asylum. Batman paid a visit to Arkham Asylum, and specifically to the Joker\'s cell. He then tells the Clown Prince of Crime that he\'s been thinking of their battles, more specifically how they\'re most likely going to end: One of them is most likely going to kill the other, whether it be Joker killing Batman, or Batman killing Joker, that most likely it may happen either sooner or later, and wonders if Joker himself is aware of that. However, he then realizes the man in the cell is not actually the Joker, and demands to know where he is. The Joker intends to drive Gotham City Police Commissioner James Gordon insane to prove that the most upstanding citizen is capable of going mad after having \"one bad day\". As part of his plan, the Joker managed to scam the owner of a run-down amusement park into giving him control, also poisoning him in the process when sha'),
...
--
-- RELATIONSHIPS FOR TABLE `user_of_notflix`:
--
