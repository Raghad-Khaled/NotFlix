                            ...
                            <form class="user" action= "edit_profile_back.php?user_name=<?php echo$name ;?>"  method="Post" enctype="multipart/form-data">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="form-group"><input class="form-control form-control-user"  type="email" data-aos="zoom-in-left" id="exampleInputEmail" aria-describedby="emailHelp"  name="email" inputmode="email" multiple="" placeholder="Enter New Email Address" value="<?=$data['EMAIL']?>" style="box-shadow: 0px 0px 12px #6f58fe;"></div>
                                        <div class="form-group"><input class="form-control form-control-user" type="password" data-aos="zoom-in-right" id="exampleInputPassword"  name="password" placeholder="Enter New Password" value="<?=$data['PASSWORD_OF_USER']?>" style="box-shadow: 0px 0px 12px #6f58fe;"></div>
