                            ...
                            <form class="user" action= "edit_profile_back.php"  method="Post" enctype="multipart/form-data">
                                <div class="p-5">
                                    <div class="avatar" style="margin-top: -10px;" >
                                        <div class="avatar-bg center" style="margin-bottom: 12px;border-style: none;box-shadow: 0px 0px 10px rgb(47,168,255); background: url(<?php echo $dirc.$_SESSION['image'];?>);"  ></div><input class="d-lg-flex align-items-lg-center form-control" type="file" data-aos="zoom-in-right"   name="avatar-file" style="padding-top: 4px;padding-right: 0px;padding-left: 7px;padding-bottom: 1px;color: var(--secondary);background: rgba(255,255,255,0);border-radius: 6px;box-shadow: inset 0px 0px 5px 0px rgb(124,106,246);margin-bottom: 2px;height: 40px;border: 1.5px dashed rgb(91,103,194);margin-top: 7px;">
                                    </div>
                                    <div class="text-center">
                                        <h3 class="pulse animated" style="color: rgb(143,85,251);font-family: 'Caveat Brush', cursive;margin-top: 4px;margin-bottom: 12px;"><?php echo $_SESSION['name'];?></h3>
                                    </div>
                                    
                                        <div class="form-group"><input class="form-control form-control-user"  type="email" data-aos="zoom-in-left" id="exampleInputEmail" aria-describedby="emailHelp"  name="email" inputmode="email" multiple="" placeholder="Enter New Email Address" value="<?=$_SESSION['email']?>" style="box-shadow: 0px 0px 12px #6f58fe;"></div>
                                        <div class="form-group"><input class="form-control form-control-user" type="password" data-aos="zoom-in-right" id="exampleInputPassword"  name="password" placeholder="Enter New Password"  style="box-shadow: 0px 0px 12px #6f58fe;"></div>
                                        ...
                                        placeholder="AGE" min="1" max="100" step="1" style="width: 111px;" value=<?=$_SESSION['age']?>><label style="margin-left: 12px;margin-bottom: 0px;">Gender:&nbsp;</label><?php echo $_SESSION['gender'];?><label style="margin-left: 3px;margin-bottom: 0px;color: rgb(118,117,249);"><?php?></label></div>
