            ...
            <div class="container">
                ...
                <div class="block-content" style="background: rgb(33,33,46);box-shadow: 0px 0px 60px rgb(45,45,68);">
                    <div class="product-info">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="gallery" style="background: rgba(135,73,237,0.32);box-shadow: inset 0px 0px 17px #af5eee;border-radius: 6px;"><a href=""><img src="assets/img/harry.jpg" style="width: 100%;height: 100%;"></a></div>
							...
							<!--------------Repeat this---->
							    ...
							    <div class="col">
							        <div class="justify-content-center spacer-slider">
							            <figure class="figure" style="  width: 100%;"><img class="figure-img" src="assets\img\poster.jpg" style="  width: 100%;" />
                        ...
                        <!------------------------------------------------------------------------------------------------------------------>
                         ...
                         <div class="row" style="padding-right: 50px;padding-left: 50px;">
							...
							<!--------------Repeat this---->
							    ...
							    <div class="col">
							        <div class="justify-content-center spacer-slider">
							            <figure class="figure" style="  width: 100%;"><img class="figure-img" src="assets\img\cover.jpg" style="  width: 100%;" />
							                <figcaption class="figure-caption" style="  font-size: 12px;">Movie 3ady</figcaption>
							            </figure>
