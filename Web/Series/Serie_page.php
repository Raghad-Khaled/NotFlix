...
$Notflixcount=$serie->countrates($id);
$count=mysqli_fetch_assoc($Notflixcount);
$Notflixrate=$serie->getSerierate($id);
            ...
            <div class="container">
                ...
                <div class="block-content" style="background: rgb(33,33,46);box-shadow: 0px 0px 60px rgb(45,45,68);">
                    <div class="product-info">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="gallery" style="background: rgba(135,73,237,0.32);box-shadow: inset 0px 0px 17px #af5eee;border-radius: 6px;">
                                <a href="<?= $data['HOME_PAGE_LINK'] ?>">
                                    <img src="<?=$data['POSTER'] ?>" style="width: 100%;height: 100%;">
                                </a>
                                </div>
                                <div style="margin-top: 22px;">
                                    <h3 style="font-family: 'Balsamiq Sans', cursive;font-size: 30px;margin-bottom: 10px;color: #8749ed;">Series Rate</h3>
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    <h4 style="font-family: Acme, sans-serif;font-size: 32px;"><?=$data['NAME_SERIES'] ?><a href="#"><img data-bs-hover-animate="tada" src="assets/img/icons8-star-64.png" style="width: 35px;margin-left: 14px;"></a>
                                    </h4>
                                    ...
                                    <div style="border-style: none;border-bottom: 1px solid rgba(120,17,250,0.42) ;">
                                        ...
                                        <?php
                                            $records=$serie->get_genre_with_serieId($data['ID']);
                                            $genre=new genre;
                                    ...
                                    <div style="border-style: none;border-bottom: 1px solid rgba(120,17,250,0.42) ;">
                                        <h4 style="border-bottom: 1px none rgb(229,229,229);font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed;margin-top: 10px;">Production Company</h4>
                                         ...
                                         <?php
                                            $records=$serie->get_company_with_serieId($data['ID']);
                                            $company=new company;
                                            while($data2 = mysqli_fetch_array($records)){
                                    ...
                                    <div style="border-style: none;border-bottom: 1px solid rgba(120,17,250,0.42) ;">
                                        <h4 style="border-bottom: 1px none rgb(229,229,229);font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed;margin-top: 10px;">Duration Per Episode</h4>
                                    ...
                                    <div style="border-style: none;border-bottom: 1px solid rgba(120,17,250,0.42) ;">
                                        ...
                                        <p class="text-left" style="margin-bottom: 10px;margin-top: 16px;margin-left: 18px;color: rgba(255,255,255,0.97);font-size: 16px;font-family: Nunito, sans-serif;"> <?=$data['REVENUE'] ?> $

                                        </p>
                                    </div>
                                    <div style="border-style: none;border-bottom: 1px solid rgba(120,17,250,0.42) ;">
                                        <h4 style="border-bottom: 1px none rgb(229,229,229);font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed;margin-top: 10px;">Number Of Episodes Per Season</h4>
                                        <p class="text-left" style="margin-bottom: 10px;margin-top: 16px;margin-left: 18px;color: rgba(255,255,255,0.97);font-size: 16px;font-family: Nunito, sans-serif;">
                                            
                                             <?=$data['NUMBER_OF_EPISODES_IN_SEASON'] ?>
                                    ...
                                    <div class="summary">
                                        <p style="margin-left: 18px;color: rgba(255,255,255,0.97);font-size: 16px;margin-bottom: 16px;font-family: Nunito, sans-serif;">
                                           <?=$data['DESCRIPTION'] ?> 
...
<!--------------Repeat this---->
                                         ...
                                         <?php
                                            $records=$serie->get_actor_with_serieId($data['ID']);
                                            $actor=new actor;
                                            while($data2 = mysqli_fetch_array($records)){
                        ...
                        <div class="m-auto" style="margin-top: 54px;margin-left: 18px;padding-right: 50px;padding-left: 50px;">
                            ...
                            <div class="m-auto blog-slider" style="margin-top: 40px;margin-left: 0px;">
                                <div class="blog-slider__wrp swiper-wrapper">
                                            ...
                                            ?>
                                    <!--------------------Repeat This For Each Season------------------------>


                                    <div class="blog-slider__item swiper-slide">
                                        <div></div>
                                        <div class="blog-slider__img"><img src="<?= $data3['POSTER'] ?>" style="max-width: 100%;max-height: 100%;
        display: block; /* remove extra space below image */ margin-top: auto;"></div>
                                        <div class="blog-slider__content"><div class="blog-slider__title">

                                            <!--------------------Link To The Season---------------------------->
                                           Season <?= $data3['SEASON_NUMBER'] ?>
