        ...
        <div class="container"><a class="navbar-brand logo" data-aos="flip-left" data-aos-duration="1450" href="#" style="color: rgba(255,255,255,0.9);font-family: Acme, sans-serif;font-size: 28px;padding-top: 0px;padding-bottom: 0px;"><img src="assets/img/5027d5fc-d38c-4aba-ab1c-e41212bf9e10_200x200.png" style="margin-top: -1px;padding-top: 13px; height: 60px"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" style="font-size: 16px;"><a class="nav-link active" href="http://localhost/NotFlix/Web/Home_movies/Movies.php?name=<?=$path?>" style="color: rgba(255,255,255,0.9);font-family: Acme, sans-serif;font-size: 18px;">Home</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    ...
                                    <div>
                                        <h4 style="margin-top: 22px;font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed; margin-left: 15px">Nomber of movies Directed</h4>
                                    </div>
                                    <div class="summary">
                                        <p style="margin-left: 22px;color: rgba(255,255,255,0.97);font-size: 16px;margin-bottom: 16px;font-family: Nunito, sans-serif;">
                            ...
                            <div class="col">
                                <div style="margin-top: 22px;">
                                    ...
                                    ?>
                                        <div class="col">
                                            <div class="justify-content-center spacer-slider" data-bs-hover-animate="pulse">
                                                <figure class="figure" style="  width: 100%;"><a href="../Series/Serie_page.php?id=<?= $Series['ID'] ?>&name=<?= $path ?> " rel="stylesheet" type="text/css"><img class="figure-img" src="<?= $Series['POSTER']?>" style="  width: 100%;" /></a>
